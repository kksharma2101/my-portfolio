...
const Introduction = () => {
  return (
    <section className="mx-4 lg:mx-5">
      <div className="bg-black h-full flex justify-between items-center p-5 mt-16 rounded-b-md">
        <div className="text-white">
          ...
          <p className="font-bold py-3">
            Hey There 👋, I`m Kamal Sharma, Web Developer <br /> Who Creates
            Dynamic real world Website and Web Applications.
          </p>
              ...
              <div className="second w-64 h-64 bg-[#9CC32763] flex justify-center items-center rounded-full">
                <div className="w-56 h-56 bg-[#9CC327] flex justify-center items-center rounded-full">
                  <Image
                    ...
                    width={100}
                    height={100}
                    className="relative -top-8 w-40 h-full"
                  />
                </div>
              </div>
            </div>
